...
public partial class VBALikeParser : Parser {
	...
	static VBALikeParser() {
		...
		public VBALikeParser(ITokenStream input) : this(input, Console.Out, Console.Error) { }

		public VBALikeParser(ITokenStream input, TextWriter output, TextWriter errorOutput)
	...
	[RuleVersion(0)]
	public LikePatternStringContext likePatternString() {
		LikePatternStringContext _localctx = new LikePatternStringContext(Context, State);
	...
	[RuleVersion(0)]
	public LikePatternElementContext likePatternElement() {
		LikePatternElementContext _localctx = new LikePatternElementContext(Context, State);
	...
	[RuleVersion(0)]
	public LikePatternCharContext likePatternChar() {
		LikePatternCharContext _localctx = new LikePatternCharContext(Context, State);
	...
	[RuleVersion(0)]
	public LikePatternCharlistContext likePatternCharlist() {
		LikePatternCharlistContext _localctx = new LikePatternCharlistContext(Context, State);
	...
	[RuleVersion(0)]
	public LikePatternCharlistElementContext likePatternCharlistElement() {
		LikePatternCharlistElementContext _localctx = new LikePatternCharlistElementContext(Context, State);
	...
	[RuleVersion(0)]
	public LikePatternCharlistRangeContext likePatternCharlistRange() {
		LikePatternCharlistRangeContext _localctx = new LikePatternCharlistRangeContext(Context, State);
	...
	[RuleVersion(0)]
	public LikePatternCharlistCharContext likePatternCharlistChar() {
		LikePatternCharlistCharContext _localctx = new LikePatternCharlistCharContext(Context, State);
	...
	private static char[] _serializedATN = {
		...
		'\x33', '\a', '\b', '\x2', '\x2', '\x32', '\x31', '\x3', '\x2', '\x2', 
		'\x2', '\x32', '\x33', '\x3', '\x2', '\x2', '\x2', '\x33', '\x34', '\x3', 
		'\x2', '\x2', '\x2', '\x34', '\x35', '\a', '\a', '\x2', '\x2', '\x35', 
		'\v', '\x3', '\x2', '\x2', '\x2', '\x36', '\x39', '\x5', '\x10', '\t', 
		'\x2', '\x37', '\x39', '\x5', '\xE', '\b', '\x2', '\x38', '\x36', '\x3', 
		'\x2', '\x2', '\x2', '\x38', '\x37', '\x3', '\x2', '\x2', '\x2', '\x39', 
		'\r', '\x3', '\x2', '\x2', '\x2', ':', ';', '\x5', '\x10', '\t', '\x2', 
		';', '<', '\a', '\b', '\x2', '\x2', '<', '=', '\x5', '\x10', '\t', '\x2', 
		'=', '\xF', '\x3', '\x2', '\x2', '\x2', '>', '?', '\n', '\x3', '\x2', 
		'\x2', '?', '\x11', '\x3', '\x2', '\x2', '\x2', '\t', '\x18', ' ', '&', 
		')', '.', '\x32', '\x38',
	};
